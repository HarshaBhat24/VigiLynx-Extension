...
// Configure file upload - limit to 50MB
const upload = multer({ limits: { fileSize: 50 * 1024 * 1024 } });

// Configure CORS headers
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', '*'); // Allow any origin for extension compatibility
...
// Helper function to format Gemini prompts and handle API responses
...
// URL/Domain/IP/Hash scanning endpoint
...
// Start the server
app.listen(PORT, () => console.log(`Security scanning server running on port ${PORT}`));